#!/usr/bin/env python3
"""Cold-cache needle test around GLM-5.3-Flash's 262K risk boundary."""
...
LENGTHS = [int(item) for item in os.getenv(
    ...
    try:
        with urllib.request.urlopen(request, timeout=TIMEOUT) as response:
            ...
            try:
                ...
                # SGLang's cache endpoint may return plain text such as
                # "Cache flushed." instead of JSON.
                return {"raw": body}
